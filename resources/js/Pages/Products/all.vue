                ...
                <div class="col-lg-12">
                    <div class="card shadow">
                        <div class="row my-3 mx-2">
                            ...
                            <div
                                class="col-md-2 column__left___padding column__right___padding"
                            >
                                <div for="purchase_uom" class="col-form-label">
                                    BRAND
                                </div>
...
const createProduct = async () => {
    ...
    try {
        ...
        const vendor = (
            await axios.post(route("product.store"), products.value)
        ).data;
